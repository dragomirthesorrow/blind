...
if($event_start_time_s<$s_rec_s){
    ...
    system("start-stop-daemon -Sbmp /var/www/html/modules/record/devices/'$cam_name'/pid_ss -x /usr/bin/ffmpeg -- -i '$video_storage''$id_event'.avi -an -ss 00:00:01 -r 1 -vframes 1  '$video_storage''$id_event'_screenshot.jpg");
